...
const myProjects = [
  {
    ...
    description:
      "Student Organizer to plan courses, mentor sessions, and homework assignments.",
  ...
  },
  {
    ...
    description:
      "App that takes the inputted or geolocated user location to display the severity, health risks, and health recommendations.",
  ...
  },
  {
    ...
    description:
      "App that allows users to create, delete, edit, and show books by title and id.",
  ...
  },
  {
    ...
    description:
      "Web app that uses NASA's API to display a photo and description of the Astronomy Photo of the Day. ",
  ...
  },
  {
    ...
    title: "Fitness App",
    description:
      "Fitness App Tracker allows users to curate workout, muscle groups to target, and objective. Users can track repetitions and workout activity.",
  ...
  },
  {
    ...
    description:
      "Final project for Intro to Programming Course at Code the Dream.",
  ...
  },
  {
    ...
    description: "Movie app that displays all and favorited movies from an API",
    image: "./projects/frontendProjects7.png",
    tags: ["Frontend"],
    demoURL: "https://tianna-spears.github.io/movieAPI/",
    githubURL: "https://github.com/tianna-spears/movieAPI",
  },
  {
    id: 8,
    title: "Todo App",
            ...
            <div className="p-6">
              <div className="flex flex-wrap gap-2 mb-4 justify-center items-center">
                {project.tags.map((tag, index) => (
                  <span
                    key={index}
                    className="px-2 py-0 text-xs font-medium border rounded-full bg-secondary text-secondary-foreground"
                  >
                    {tag}
                  </span>
                ))}
